...
5. [base_tools_quickstart](./base_tools_quickstart/): first-party portfolio-risk workspace quickstart exposing `read`, `find`, `grep`, and `write` through `HarnessToolsShim`.
